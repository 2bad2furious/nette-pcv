...
class Router {
    ...
    public function createRouter(): \Nette\Application\IRouter {
        ...
        $router[] = new Route("<" . frontModule\PagePresenter::PARAM_URL . " .+>", "front:NoLang:", Route::ONE_WAY);
...
//        $frontRouteList[] = new Route("<presenter>/<action>");
        ...
        $adminRouteList[] = new Route("admin/<locale $availableAdminLangs>/<presenter file>/<action all>");
